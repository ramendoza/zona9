        ...
        $map.slideToggle({
            complete: function() {
                ...
                if (!isMapLoaded) {
                    ...
                    map = new GMaps({
                        el: '#gmap-wrapper',
                        lat: 18.946065, //Replace Here Location Google Map Lat
                        lng: -99.198429, //Replace Here Location Google Map Lng
                        scrollwheel: false,
                        zoom: 17,
                        zoomControl: true,
                        panControl: true,
                    ...
                    map.addMarker({
                        lat: 18.946065, //Replace Here Location Google Map Lat
                        lng: -99.198429, //Replace Here Location Google Map Lat
                        icon: image,
